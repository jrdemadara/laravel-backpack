...
/**
* @see \App\Http\Controllers\Admin\ContactCrudController::show
* @see app/Http/Controllers/Admin/ContactCrudController.php:71
* @route '/admin/contact/{id}/show'
*/
...
const ContactCrudController = { index, search, showDetailsRow, create, store, edit, update, destroy, show }
